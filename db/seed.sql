...
INSERT INTO aulas (trilha_id, slug, titulo, resumo, ordem, tempo_minutos, tipo, nivel, precisa_pagina, publicada) VALUES
  ...
  ('html-css', 'esqueleto', 'Esqueleto', 'doctype, html, head, body, charset, title e viewport.', 2, 15, 'aula', 'basico', false, false),
  ('html-css', 'texto-e-titulos', 'Texto e títulos', 'h1 a h3, parágrafo, negrito e ênfase.', 3, 15, 'aula', 'basico', false, false),
  ('html-css', 'links-imagens-listas', 'Links, imagens e listas', 'a, img com alt, listas numeradas e com marcador.', 4, 20, 'aula', 'basico', false, false),
  ('html-css', 'nomear-pecas', 'Nomear peças', 'id, class e div: o gancho que o JavaScript vai usar.', 5, 20, 'aula', 'basico', false, false),
  ('html-css', 'botao-e-formulario', 'Botão e formulário', 'button, input, label, form e checkbox. Sem JavaScript ainda.', 6, 20, 'aula', 'basico', false, false),
  ('html-css', 'css-ligar-e-vestir', 'CSS: ligar e vestir', 'Arquivo CSS, seletores, cor e letra.', 7, 20, 'aula', 'basico', false, false),
  ('html-css', 'caixa-e-lado-a-lado', 'Caixa e lado a lado', 'margin, padding, border e três botões em fila.', 8, 20, 'aula', 'basico', false, false),
  ('html-css', 'projeto-pagina-sua', 'Mini-projeto: uma página sua', 'Título, texto, imagem, lista e um botão. Depois: JavaScript ou HTML intermediário (em breve).', 9, 30, 'projeto', 'basico', false, false),
