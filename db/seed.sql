...
INSERT INTO aulas (trilha_id, slug, titulo, resumo, ordem, tempo_minutos, tipo, nivel, precisa_pagina, publicada) VALUES
  ...
  ('html-css', 'projeto-pagina-sua', 'Mini-projeto: uma página sua', 'Título, texto, imagem, lista e um botão. Quando terminar, o próximo passo é o JavaScript.', 10, 30, 'projeto', 'basico', false, false),
  ...
  ('javascript', 'erros', 'Erros de verdade', 'try/catch e mensagem para a pessoa, sem alert no site publicado.', 5, 20, 'aula', 'avancado', false, false),
