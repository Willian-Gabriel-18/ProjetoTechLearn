...
<style scoped>
.navItem{
  @apply md:text-xl flex items-center px-2 py-1 rounded-md gap-1 md:hover:scale-110 hover:cursor-pointer md:hover:text-orange-500 md:hover:shadow md:hover:shadow-orange-500 transition-all duration-75;
}
