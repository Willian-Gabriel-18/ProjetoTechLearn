...
<section class="py-8 px-4 md:px-24">
  ...
  <div class="py-2 px-1">
    <img :src="noticia.imagem_principal" :alt="'Banner notícia' - noticia.subtitulo" class="rounded-lg outline outline-stone-400 outline-2 outline-offset-4">
  </div>

  <p class="texto mt-4" >{{ noticia.resumo }}</p>
