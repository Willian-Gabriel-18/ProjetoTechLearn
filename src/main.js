...
import getNewsData from './utilities/getNewsJSONData.js';
import getTutorialsData from './utilities/getTutorialsJSONData.js';
...
application.provide('NewsData', getNewsData());
application.provide('TutorialsData', getTutorialsData());
